...
import { ROOT_ALIAS_GROUP, FILE_NAMES } from "../constants";
import type { CatalogsOptions, CatalogsConfiguration } from "../types";
...
export class CatalogConfigurationReader {
  ...
  async readConfiguration(project: Project): Promise<CatalogsConfiguration> {
    ...
    const catalogsYmlPath = ppath.join(project.cwd, FILE_NAMES.CATALOGS_YML);
